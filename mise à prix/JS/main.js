...
//
var SNOW_Picture =
  "https://static.wikia.nocookie.net/dragonquest/images/a/aa/Gluante.png/revision/latest?cb=20151213114935&path-prefix=fr";
var SNOW_no = 15;
  ...
  if (i == 0)
    document.write(
      '<div id="SNOW_flake' +
        ...
        i +
        '; visibility: visible; top: 15px; left: 15px;"><a href="#" target="_blank"><img src="' +
        SNOW_Picture +
        '" border="0"></a></div>'
    );
  else
